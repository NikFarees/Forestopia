...
SELECT 
    ...
    SUM(CASE WHEN r50.Status = 'cut' THEN f.Volume ELSE 0 END) / 100 AS production_0, 
    SUM(CASE WHEN r50.Status = 'victim' THEN f.Volume ELSE 0 END) / 100 AS damage_0, 
    SUM(y30_50.Volume30 - f.Volume) / 100 AS growth_30,
    SUM(CASE WHEN y30_50.Status45 = 'cut' THEN y30_50.Volume30 ELSE 0 END) / 100 AS production_30_regime_45, 
    SUM(CASE WHEN y30_50.Status50 = 'cut' THEN y30_50.Volume30 ELSE 0 END) / 100 AS production_30_regime_50,
    SUM(CASE WHEN y30_50.Status55 = 'cut' THEN y30_50.Volume30 ELSE 0 END) / 100 AS production_30_regime_55,
    SUM(CASE WHEN y30_50.Status60 = 'cut' THEN y30_50.Volume30 ELSE 0 END) / 100 AS production_30_regime_60
FROM 
    year0_forest f
LEFT JOIN 
    year0_regime50 r50 ON f.TreeNum = r50.TreeNum
LEFT JOIN 
    year30_regime50 y30_50 ON f.TreeNum = y30_50.TreeNum
GROUP BY 
    f.SpeciesGroup
ORDER BY 
    f.SpeciesGroup;
...
<main class="main">
    <section id="chart" class="chart section">
        <div class="container section-title" data-aos="fade-up">
            <h2>Regime 50 Chart</h2>
        </div>
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <div class="chart-container">
                <canvas id="regime50Chart"></canvas>
            </div>
        </div>
    </section>
</main>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const ctx = document.getElementById('regime50Chart').getContext('2d');
        const regime50Chart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: labels,
                datasets: [
