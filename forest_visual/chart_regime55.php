...
SELECT 
    ...
    SUM(CASE WHEN r55.Status = 'cut' THEN f.Volume ELSE 0 END) / 100 AS production_0, 
    SUM(CASE WHEN r55.Status = 'victim' THEN f.Volume ELSE 0 END) / 100 AS damage_0, 
    SUM(y30_55.Volume30 - f.Volume) / 100 AS growth_30,
    SUM(CASE WHEN y30_55.Status45 = 'cut' THEN y30_55.Volume30 ELSE 0 END) / 100 AS production_30_regime_45, 
    SUM(CASE WHEN y30_55.Status50 = 'cut' THEN y30_55.Volume30 ELSE 0 END) / 100 AS production_30_regime_50,
    SUM(CASE WHEN y30_55.Status55 = 'cut' THEN y30_55.Volume30 ELSE 0 END) / 100 AS production_30_regime_55,
    SUM(CASE WHEN y30_55.Status60 = 'cut' THEN y30_55.Volume30 ELSE 0 END) / 100 AS production_30_regime_60
FROM 
    year0_forest f
LEFT JOIN 
    year0_regime55 r55 ON f.TreeNum = r55.TreeNum
LEFT JOIN 
    year30_regime55 y30_55 ON f.TreeNum = y30_55.TreeNum
GROUP BY 
    f.SpeciesGroup
ORDER BY 
    f.SpeciesGroup;
...
<main class="main">
    <section id="chart" class="chart section">
        <div class="container section-title" data-aos="fade-up">
            <h2>Regime 55 Chart</h2>
        </div>
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <div class="chart-container">
                <canvas id="regime55Chart"></canvas>
            </div>
        </div>
    </section>
</main>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const ctx = document.getElementById('regime55Chart').getContext('2d');
        const regime55Chart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: labels,
                datasets: [
