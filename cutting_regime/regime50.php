    ...
    <section id="about" class="about section">
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <tbody>
                                ...
                                foreach ($speciesGroups as $spgroup => $groupName) {
                                    ...
                                    $sql = "
                                        ...
                                        LEFT JOIN year0_regime50 t ON yf.TreeNum = t.TreeNum
                                        LEFT JOIN year0_regime50 yr ON yf.TreeNum = yr.TreeNum
                                    ...
                                    // Damage 0 (total volume of trees with status 'victim' from year0_regime50)
                                    ...
                                    $sqlGrowth = "
                                        SELECT 
                                            (SUM(t.Volume30) - (
                                                ...
                                                FROM year0_forest yf
                                                JOIN year0_regime50 t0 ON yf.TreeNum = t0.TreeNum
            ...
            <div class=" container mt-5" data-aos="fade-up">
                <?php
                // Include the chart from chart_regime50.php
                include '../forest_visual/chart_regime50.php';
                ?>
            </div>
        </div>
